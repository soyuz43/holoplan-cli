...
func safeBuild(view types.ViewLayout) (string, bool) {
	...
	if err := doc.ReadFromString(xml); err != nil {
		log.Printf("⚠️ Invalid XML generated by Build: %v", err)
		return "", false
	}
	return xml, ok
}
...
func safeResolve(xml string, critique types.Critique, story types.UserStory) (string, bool) {
	defer recoverLLM("Resolve")
	return agents.Resolve(xml, critique, story), true
}
